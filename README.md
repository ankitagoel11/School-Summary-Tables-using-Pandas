# School-Summary-Tables-using-Pandas
...
* Created a table that breaks down school performances based on average Spending Ranges (Per Student). Use 4 reasonable bins to group school spending. Each of the following categories are included:
  * Average Math Score
  * Average Reading Score
  * % Passing Math
  * % Passing Reading
